// Arni eQMS — Mock Data for all modules
...
export const users = [
  { id: 1, name: 'Dr. Sarah Chen', role: 'Quality Director', department: 'Quality', email: 'sarah.chen@arnieqms.com', status: 'active' },
  { id: 2, name: 'James Miller', role: 'R&D Manager', department: 'R&D', email: 'james.miller@arnieqms.com', status: 'active' },
  { id: 3, name: 'Emily Rodriguez', role: 'Training Coordinator', department: 'HR', email: 'emily.rodriguez@arnieqms.com', status: 'active' },
  { id: 4, name: 'Michael Park', role: 'Supply Chain Lead', department: 'Supply Chain', email: 'michael.park@arnieqms.com', status: 'active' },
  { id: 5, name: 'Lisa Wang', role: 'Validation Engineer', department: 'Engineering', email: 'lisa.wang@arnieqms.com', status: 'active' },
  { id: 6, name: 'Robert Kim', role: 'Production Supervisor', department: 'Production', email: 'robert.kim@arnieqms.com', status: 'active' },
];
